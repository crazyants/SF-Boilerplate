...
namespace SF.Module.Backend.Controllers
{
    ...
    [Route("Organize/")]
    public class OrganizeController : SF.Web.Base.Controllers.ControllerBase
    {
        /// <summary>
        /// 
        /// </summary>
        private readonly IBackendUnitOfWork _backendUnitOfWork;
        public OrganizeController(IServiceCollection collection, ILogger<OrganizeController> logger,
