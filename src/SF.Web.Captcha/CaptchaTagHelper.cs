...
namespace SF.Web.Captcha
{
    ...
    /// SFCaptcha TagHelper
    /// </summary>
    [HtmlTargetElement("sf-captcha")]
    public class CaptchaTagHelper : TagHelper
    {
        /// <summary>
        /// The default hidden input name of the captcha.
        /// </summary>
        public static readonly string CaptchaHiddenInputName = "SFCaptchaText";

        /// <summary>
        /// The default hidden input name of the captcha's cookie token.
        /// </summary>
        public static readonly string CaptchaHiddenTokenName = "SFCaptchaToken";

        /// <summary>
        /// The default input name of the captcha.
        /// </summary>
        public static readonly string CaptchaInputName = "SFCaptchaInputText";
        ...
        /// <summary>
        /// The digits value of the captcha. It's default value is 4.
        /// </summary>
        [HtmlAttributeName("asp-captcha-generator-digits")]
        public int Digits { set; get; } = 4;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.TagName = "div";
            output.Attributes.Add("class", "sfCaptcha");
            output.Attributes.Add("id", $"sfCaptcha.{_randomNumberProvider.Next(Min, Max)}");
            output.TagMode = TagMode.StartTagAndEndTag;

            var number = Digits > 0 ? Digits : _randomNumberProvider.Next(Min, Max);
        ...
        private TagBuilder getCaptchaImageTagBuilder(string encryptedText)
        {
            ...
            var sfCaptchaImg = "sfCaptchaImg";
            captchaImage.Attributes.Add("id", sfCaptchaImg);
            captchaImage.Attributes.Add("name", sfCaptchaImg);
