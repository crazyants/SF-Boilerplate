(function ($) {
    ...
    SF.controls.imageUploader = (function () {
        var _configure = function (options) {
            ...
            var wsUrl = SF.settings.get('baseUrl')
                        + 'ImageUploader.ashx?'
            ...
            $('#' + options.controlId).fileupload({
                ...
                start: function (e, data) {
                    ...
                    $el.find('.js-upload-progress').sfFadeIn();
                },
                ...
                stop: function (e) {
                    ...
                    $el.find('.imageupload-dropzone').sfFadeIn();
                },
                done: function (e, data) {
                    var $el = $('#' + options.imgThumbnail);
                    $('#' + options.hfFileId).val(data.response().result.Id);
                    var getImageUrl = SF.settings.get('baseUrl')
                        + 'GetImage.ashx?'
                ...
                fail: function (e, data) {
                    var $el = $('#' + options.controlId).closest('.imageupload-group');
                    $el.siblings('.js-sfupload-alert').remove();
                    var $warning = $('<div class="alert alert-warning alert-dismissable js-sfupload-alert"/>');
            ...
            $('#' + options.aRemove).click(function () {
                $(this).hide();
                var $el = $('#' + options.imgThumbnail);
                var noPictureUrl = options.noPictureUrl || SF.settings.get('baseUrl') + 'Assets/Images/no-picture.svg';
                if ($el.is('img')) {
