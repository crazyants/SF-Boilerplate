(function () {
    ...
    SF.controls.searchField = (function () {
        var exports,
        ...
        SearchField.prototype = {
            ...
            initialize: function () {
                ...
                var key = sessionStorage.getItem("com.sfrms.search");
                if (key && key != '') {
                ...
                this.$el.typeahead({
                    ...
                    limit: 15,
                    remote: {
                        url: SF.settings.get('baseUrl') + 'api/search?type=%TYPE&term=%QUERY&$top=15',
            ...
            initializeEventHandlers: function () {
                var self = this,
                    search = function (term) {
                        var keyVal = self.$el.parents('.smartsearch').find('input:hidden').val(),
                            ...
                            url = SF.settings.get('baseUrl') + targetUrl.replace('{0}', encodeURIComponent(term.trim()));
                ...
                this.$el.parents('.smartsearch').find('.dropdown-menu a').click(function () {
                    ...
                    sessionStorage.setItem("com.sfrms.search", key);
