var SFPasteFromWord = function (context) {
    var ui = $.summernote.ui;

    $(context.layoutInfo.note).on('summernote.paste', function (we, e) {
        // catch the paste event and do either the sfpastetext or sfpastefromword if we can figure out if they are pasting from word
        ...
        if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
            ...
            e.preventDefault();
            context.layoutInfo.toolbar.find('.js-sfpastetext').click();
        } else {
    ...
    var $dialog = ui.dialog({
        className: 'sfpastefromword-dialog',
