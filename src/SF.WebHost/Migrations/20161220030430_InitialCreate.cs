        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginProvider = table.Column<string>(maxLength: 280, nullable: false),
                    Name = table.Column<string>(maxLength: 280, nullable: false),
                    Value = table.Column<string>(maxLength: 280, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    LoginProvider = table.Column<string>(maxLength: 280, nullable: false),
                    ProviderKey = table.Column<string>(maxLength: 280, nullable: false),
