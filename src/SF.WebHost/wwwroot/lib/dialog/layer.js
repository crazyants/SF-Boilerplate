...
var layer = {
  ...
  ready: function(callback){
    ...
    isLayui ? layui.addcss('default/layer.css?v='+layer.v+ver, callback, cssname)
    : layer.link('default/layer.css?v='+layer.v+ver, callback, cssname);
    return this;
  },
...
Class.pt.creat = function(){
  ...
  switch(config.type){
    ...
    case 2:
        ...
        config.content = ajaxloader + '<iframe scrolling="' + (config.content[1] || 'auto') + '" allowtransparency="true" id="' + config.id + '" name="' + config.id + '" onload="SF.utility.loading(false);" class="layui-layer-load" frameborder="0" src="' + config.content[0] + '"></iframe>';
    break;
    case 3:
      delete config.title;
