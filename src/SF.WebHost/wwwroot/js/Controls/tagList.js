    ...
    SF.controls.tagList = (function () {
        ...
        TagList.prototype.verifyTag = function (tagName) {
            ...
            var tagList = exports.tagLists[$(this).attr('id')],
                restUrl = SF.settings.get('baseUrl') + 'api/tags';
                ...
                statusCode: {
                    404: function () {
                        if (tagList.preventTagCreation) {
                            ...
                            SF.dialogs.confirm('A tag called "' + $('<div/>').text(tagName).html() + '" does not exist. Do you want to create a new personal tag?', function (result) {
                                if (result) {
        ...
        TagList.prototype.addTag = function (tagName) {
            ...
            var tagList = this,
                restUrl = SF.settings.get('baseUrl') + 'api/taggeditems'
            restUrl += '/' + tagList.entityTypeId;
            restUrl += '/' + tagList.currentPersonId;
            ...
            if (!tagList.delaySave) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        ...
                        SF.dialogs.alert("Unable to remove tag: " + error);
        ...
        TagList.prototype.initialize = function () {
            ...
            var autoCompleteUrlPrefix = SF.settings.get('baseUrl') + 'api/tags/availablenames';
