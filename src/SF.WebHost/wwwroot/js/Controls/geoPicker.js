(function ($) {
    ...
    SF.controls.geoPicker = (function () {
        ...
        GeoPicker.prototype.initializeEventHandlers = function () {
            ...
            */
            $('#' + controlId + ' a.picker-label').click(function (e) {
                ...
                $control.find('.picker-menu').first().toggle(function () {
                    SF.dialogs.updateModalScrollBar(controlId);
                });
            ...
            */
            $('#btnExpandToggle_' + controlId).click(function () {
                ...
                SF.dialogs.updateModalScrollBar(self.controlId);
            ...
            */
            ...
            /**
            * Handle the Select button click by stuffing the SFGoogleGeoPicker's path value into the hidden field. 
            */
        ...
        */
        ...
        var exports = {
            googleMapsLoadCallback: function () {
                ...
                $.each(SF.controls.geoPicker.geoPickerOptions, function (a, options) {
                    var geoPicker = SF.controls.geoPicker.geoPickers[options.controlId];
                    if (!geoPicker) {

                        geoPicker = new GeoPicker(options);
                        SF.controls.geoPicker.geoPickers[options.controlId] = geoPicker;
