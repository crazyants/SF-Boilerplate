(function ($) {
    ...
    SF.controls.personPicker = (function () {
        ...
        PersonPicker.prototype.initializeEventHandlers = function () {
            var controlId = this.controlId,
                ...
                restDetailUrl = this.restDetailUrl || (SF.settings.get('baseUrl') + 'api/People/GetSearchDetails'),
        ...
        PersonPicker.prototype.updateScrollbar = function () {
            ...
            SF.dialogs.updateModalScrollBar(this.controlId);
        }
