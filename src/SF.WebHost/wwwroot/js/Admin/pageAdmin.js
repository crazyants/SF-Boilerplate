        ...
        var $moveLink,
            _saveBlockMove = function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: SF.settings.get('baseUrl') + 'api/blocks/' + blockId,
                    success: function (getData, status, xhr) {
                        ...
                        if ($('#block-move-Location_0').prop('checked')) {
                            ...
                            getData.PageId = SF.settings.get('pageId');
                        }
                        else {
                            getData.LayoutId = SF.settings.get('layoutId');
                            getData.PageId = null;
                        }
                        ...
                        $.ajax({
                            ...
                            url: SF.settings.get('baseUrl') + 'api/blocks/move/' + blockId,
