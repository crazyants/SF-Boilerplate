...
using SF.Core.Dapper.Expressions;
...
{
    public class DapperRepositoryBase<TDbContext, TEntity, TPrimaryKey> : SFDapperRepositoryBase<TEntity, TPrimaryKey>
        where TEntity :  BaseEntity<TPrimaryKey>
        where TDbContext : DbContext
    {
        private readonly TDbContext _dbContextProvider;

        public DapperRepositoryBase(TDbContext dbContextProvider)
        {
        ...
        {
            get { return Context.Database.CurrentTransaction.GetDbTransaction(); }
        }
