...
{
    public class DistrictRepository : EFCoreQueryableRepository<DistrictEntity, long>, IDistrictRepository
    {
        public DistrictRepository(DbContext context) : base(context)
        {
        }
        public override IQueryable<DistrictEntity> QueryById(long id)
        {
