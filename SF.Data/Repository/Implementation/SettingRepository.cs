...
{
    public class SettingRepository : EFCoreQueryableRepository<SettingEntity, long>, ISettingRepository
    {
        public SettingRepository(DbContext context) : base(context)
        {
        }
        public override IQueryable<SettingEntity> QueryById(long id)
        {
