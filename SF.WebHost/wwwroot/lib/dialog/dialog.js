    ...
    f.pt.creat = function () {
        ...
        switch ("string" == typeof b.area && (b.area = "auto" === b.area ? ["", ""] : [b.area, ""]), b.type) {
            ...
            case 2:
                ...
                b.content = ajaxloader + '<iframe scrolling="' + (b.content[1] || "auto") + '" allowtransparency="true" id="' + b.id + '" name="' + b.id + '" onload="SF.utility.loading(false);" frameborder="0" src="' + b.content[0] + '"></iframe>';
                break;
            case 3:
                b.title = !1,
                b.closeBtn = !1,
