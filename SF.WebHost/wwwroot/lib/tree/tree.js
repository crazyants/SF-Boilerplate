        ...
        var dfop =
            {
                 ...
                 */
                cbiconpath: "/lib/tree/images/icons/",
                ...
                onnodeclick: false,
                /**
                  * @description {Event} callback:function(tree, item)
                  * Fired when a node is clicked on.
                  * @param {Object} tree This tree object. 
                  * @param {Object} item Ndde item clicked on.
                */
        ...
        function asnyloadc(pnode, isAsync, callback) {
            if (dfop.url) {
                ...
                $.ajax({
                    ...
                    success: callback,
                    error: function (e) { SF.utility.dialogMsg("·þÎñ¶ËÎ´ÏìÓ¦¡£", -1); }
                });
            }
        }
