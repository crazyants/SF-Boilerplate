(function ($) {
    ...
    SF.controls.followingsToggler = (function () {
            ...
            initialize: function ($followingDiv, entityTypeId, entityId, personId, personAliasId) {
                $followingDiv.click(function () {
                    if ($followingDiv.hasClass('following')) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: SF.settings.get('baseUrl') + 'api/followings/' + entityTypeId + '/' + entityId + '/' + personId,
                        ...
                        $.ajax({
                            ...
                            url: SF.settings.get('baseUrl') + 'api/followings',
                            statusCode: {
                                201: function () {
